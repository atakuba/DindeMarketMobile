...
import 'package:dinde_market/pages/navigation_page/profile_page/contact_us_page.dart';
import 'package:dinde_market/pages/navigation_page/profile_page/order_history_page.dart';
import 'package:dinde_market/pages/navigation_page/profile_page/payment_page.dart';
                      ...
                      Row(
                        ...
                        children: [
                          Container(
                            ...
                            child: const Icon(Icons.credit_card_outlined, color: Colors.white,),
                          ),
                      const Text("Способы оплаты", style: TextStyle(fontSize: 15, fontWeight: FontWeight.w500),),
                        ],
                      ),
                      Container(
                            margin: const EdgeInsets.all(15),
